...
You also test [http://rubydoc.info/github/capistrano/capistrano/master/Capistrano/Configuration/Callbacks](callbacks) to see if your tasks are being called at the right time:
